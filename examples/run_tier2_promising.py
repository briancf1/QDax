"""
DNS-GA Tier 2: Promising Variants

Low overhead configurations that might offer good balance
between forecasting benefit and computational cost.
"""
...
def main():
    ...
    output_dir = f"dns_ga_tier2_{timestamp}"
    os.makedirs(output_dir, exist_ok=True)
    
    print(f"\n{'='*80}")
    print(f"DNS-GA Tier 2: Promising Variants - {timestamp}")
    print(f"{'='*80}")
    ...
    results_file = os.path.join(output_dir, "tier2_results.json")
